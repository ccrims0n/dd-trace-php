...
static PHP_FUNCTION(dd_trace) {
    ...
    if (ddtrace_should_warn_legacy()) {
        char *message =
            "dd_trace DEPRECATION NOTICE: the function `dd_trace(%s%s%s)` is deprecated and will become a no-op in the"
            " next release, and eventually will be removed. Please follow "
